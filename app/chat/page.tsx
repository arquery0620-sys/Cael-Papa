                ...
                <div className={`flex items-end gap-2 ${isUser ? "flex-row-reverse" : "flex-row"}`}>
                  ...
                  <div className="max-w-[72%] min-w-0 overflow-hidden flex flex-col gap-1">
                    ...
                    {isEditing ? (
                      ...
                      msg.content && (
                        <div className={`px-4 py-2.5 text-sm leading-relaxed break-all overflow-hidden max-w-full min-w-0 ${isUser ? "rounded-[20px_20px_4px_20px]" : "rounded-[20px_20px_20px_4px]"}`}
                          style={{
