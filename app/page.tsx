  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] flex flex-col px-6 pt-14">
      ...
      <div className="flex flex-col gap-3">
        ...
        <a href="/board" className="bg-white rounded-2xl p-5 border border-[#f0ebe3] text-sm text-[#2c2018]">
          📌 留言板
        </a>
        <a href="/settings" className="bg-white rounded-2xl p-5 border border-[#f0ebe3] text-sm text-[#2c2018]">
          ⚙️ 设置
        </a>
      </div>
    </div>
