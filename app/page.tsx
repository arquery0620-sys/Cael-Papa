        ...
        <div className="fixed inset-0 z-40 flex">
          <div className="w-72 bg-white h-full flex flex-col shadow-xl">
            ...
            <div className="flex-1 overflow-y-auto px-3 py-3 flex flex-col gap-1">
              ...
              <Link href="/" onClick={() => setShowMenu(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-[#faf8f5]">
                <HomeIcon className="w-5 h-5 text-[#c4b5a0]" />
                <span className="font-[family-name:var(--font-cormorant)] text-lg text-[#2c2018]">Home</span>
              </Link>

              <Link href="/chat" onClick={() => setShowMenu(false)} className="flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-[#faf8f5]">
