  ...
  <div className="flex-1 px-6 pt-4 flex flex-col gap-4 pb-24">
    ...
    <div className="bg-white rounded-2xl p-5 border border-[#f0ebe3]">
      ...
      <textarea
        ...
        placeholder="输入爸爸的人设..."
        className="w-full h-36 text-sm text-[#2c2018] bg-[#faf8f5] rounded-xl p-3 border border-[#f0ebe3] resize-none focus:outline-none focus:border-[#c4a882]"
      />
    </div>
    ...
    <div className="bg-white rounded-2xl p-5 border border-[#f0ebe3]">
      ...
      <input
        ...
        className="w-full text-sm text-[#2c2018] bg-[#faf8f5] rounded-xl p-3 border border-[#f0ebe3] focus:outline-none focus:border-[#c4a882]"
      />
